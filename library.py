...
Button(button_frame, text="Add Entry", command=add_entry, font=("Arial", 12), bg="#5bc0de", fg="white").pack(fill="x", pady=5)
Button(button_frame, text="Update Selected", command=update, font=("Arial", 12), bg="#f0ad4e", fg="white").pack(fill="x", pady=5)
Button(button_frame, text="Delete Selected", command=delete, font=("Arial", 12), bg="#d9534f", fg="white").pack(fill="x", pady=5)
